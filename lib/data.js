/**
 * EVONUT Data - JSON hardcoded con toda la información del proyecto
 * Reemplaza la base de datos. No hay backend, solo datos estáticos.
 */
...
export const brands = [
  {
    ...
    slug: "ena",
    origin: "nacional",
    description: "Marca argentina muy elegida por quienes buscan rendimiento confiable y buena relación precio-calidad.",
    featured: true,
    sortOrder: 1,
  },
  {
    ...
    slug: "star-nutrition",
    origin: "nacional",
    description: "Suplementación deportiva orientada a fuerza, recuperación y uso diario en entrenamiento.",
    featured: true,
    sortOrder: 2,
  },
  {
    ...
    slug: "body-advance",
    origin: "nacional",
    description: "Opciones pensadas para sumar calorías, proteínas y apoyo nutricional para objetivos de volumen.",
    featured: false,
    sortOrder: 3,
  },
  {
    ...
    slug: "nutremax",
    origin: "nacional",
    description: "Línea de suplementos versátil para sumar proteínas, energía y apoyo general.",
    featured: false,
    sortOrder: 4,
  },
  {
    ...
    slug: "hoch-sport",
    origin: "importado",
    description: "Perfil más técnico, ideal para quienes priorizan resistencia, calidad y recuperación.",
    featured: false,
    sortOrder: 5,
  },
  {
    ...
    slug: "max-force",
    origin: "importado",
    description: "Marca de enfoque intenso para rendimiento, fuerza y entrenamientos demandantes.",
    featured: true,
    sortOrder: 6,
  },
  {
    ...
    slug: "gold-nutrition",
    origin: "importado",
    description: "Suplementación premium orientada a atletas y personas activas.",
    featured: false,
    sortOrder: 7,
  },
  {
    ...
    slug: "mervick",
    origin: "nacional",
    description: "Opciones accesibles para complementar alimentación y rutina deportiva.",
    featured: false,
    sortOrder: 8,
  },
  {
    ...
    slug: "xtrenght",
    origin: "importado",
    description: "Marca orientada a pre entrenos, energía y objetivos de alta exigencia.",
    featured: true,
    sortOrder: 9,
  },
  {
    ...
    slug: "la-ganexa",
    origin: "nacional",
    description: "Snacks y pastas de maní para sumar calorías de forma práctica y rica.",
    featured: true,
    sortOrder: 10,
  },
];
...
export const products = [
  ...
  },
  {
    ...
    slug: "creatina-star-nutrition-monohydrate",
  ...
  },
  {
    ...
    slug: "glutamina-recovery-star-nutrition",
  ...
  },
  {
    ...
    slug: "pasta-de-maní-crunch-la-ganexa",
  ...
  },
  {
    ...
    slug: "pre-workout-xtrenght-rush",
  ...
  },
  {
    ...
    slug: "isolate-gold-nutrition-pure-whey",
  ...
  },
  {
    ...
    slug: "creatina-max-force-reload",
  ...
  },
  {
    ...
    slug: "runner-recovery-gold-nutrition",
...
export const articles = [
  {
    ...
    slug: "que-es-la-proteina-whey-y-cuando-te-puede-servir",
    ...
    category: "Proteínas",
    coverImage: "/images/campaigns/funcion-proteinas.png",
    featured: true,
    sortOrder: 1,
  },
  {
    ...
    slug: "para-que-sirve-la-creatina-y-por-que-es-tan-elegida",
    ...
    category: "Creatinas",
    coverImage: "/images/campaigns/mitos-creatina.png",
    featured: true,
    sortOrder: 2,
  },
  {
    ...
    slug: "cuando-conviene-un-ganador-de-peso",
  ...
  },
  {
    ...
    slug: "que-sirve-para-correr-y-recuperarse-mejor",
    ...
    category: "Running",
    coverImage: "/images/campaigns/beneficios-run.png",
    featured: true,
    sortOrder: 4,
  },
  {
    ...
    slug: "como-combinar-suplementos-basicos-sin-exagerar",
    ...
    category: "Guías",
    coverImage: "/images/campaigns/ganexa-postrecito.png",
    featured: false,
    sortOrder: 5,
  },
  {
    ...
    slug: "diferencias-entre-suplementacion-para-gym-y-para-running",
    ...
    category: "Guías",
    coverImage: "/images/campaigns/clasificacion-proteinas.png",
    featured: false,
    sortOrder: 6,
  },
];
...
export const campaigns = [
  {
    id: 1,
    title: "Clasificación de proteínas",
    description:
      "Ideal para la sección educativa: explica diferencias entre aislada, común y vegetal con una pieza ya lista para Instagram y web.",
    image: "/images/campaigns/clasificacion-proteinas.png",
    href: "/info/que-es-la-proteina-whey-y-cuando-te-puede-servir",
    tag: "Educación",
  },
  {
    id: 2,
    title: "Beneficios del running",
    description:
      "Encaja muy bien cerca de la guía por objetivos o como apoyo a categorías de energía, resistencia y recuperación.",
    image: "/images/campaigns/beneficios-run.png",
    href: "/info/que-sirve-para-correr-y-recuperarse-mejor",
    tag: "Running",
  },
  {
    id: 3,
    title: "Función de las proteínas",
    description:
      "Sirve como portada fuerte para contenido orientativo y ayuda a vender proteína desde educación, no solo desde precio.",
    image: "/images/campaigns/funcion-proteinas.png",
    href: "/info/que-es-la-proteina-whey-y-cuando-te-puede-servir",
    tag: "Proteínas",
  },
  {
    id: 4,
    title: "Mitos sobre la creatina",
    description:
      "Muy buena pieza para derribar objeciones frecuentes antes de que el cliente pregunte por WhatsApp.",
    image: "/images/campaigns/mitos-creatina.png",
    href: "/info/para-que-sirve-la-creatina-y-por-que-es-tan-elegida",
    tag: "Creatina",
  },
];
...
export const siteContent = {
  ...
  mapEmbedUrl: "https://www.google.com/maps?q=Bariloche%20Rio%20Negro&output=embed",
};
